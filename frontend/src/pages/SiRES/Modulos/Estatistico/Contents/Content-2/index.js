...
import {FaInfoCircle,FaSearch,FaArrowDown,FaArrowUp, FaRegCalendarAlt} from "react-icons/fa"
...
export default function Content1(){
    ...
    useEffect(() => {
      api.post('sires/defaultEst',{'temp':'moth'}).then(res => {
    ...
    function controllContent(n_controll){
        document.getElementById('cont-box-2-' + n_controll).style.background = 'rgb(24,14,126)'
        document.getElementById('cont-box-2-' + n_controll).style.color = 'white'
        document.getElementById('content-box-2-' + n_controll).style.display = 'block'
        for (let i = 1;i < 5;i++){
          if (i !== parseInt(n_controll)){
      
            document.getElementById('cont-box-2-' + i.toString()).style.background = 'transparent'
            document.getElementById('cont-box-2-' + i.toString()).style.color = 'blue'
            document.getElementById('content-box-2-' + i).style.display = 'none'
    ...
    <div  id="content-2">
        <div class="resumo">
          ...
          <div class="content-diario">
            <div class="bar">
              <button onClick={() => controllContent(1)} id="cont-box-2-1" type="button" name="button">{day_name}</button>
              <button onClick={() => controllContent(2)} id="cont-box-2-2" type="button" name="button">Items</button>
              <button onClick={() => controllContent(3)} id="cont-box-2-3" name="button">Melhor Dia</button>
              <button onClick={() => controllContent(4)} id="cont-box-2-4" name="button">Pior Dia</button>

            </div>
            <div class="content-bar-selection">
              <div class="content-box" id="content-box-2-1">
              ...
              <div class="content-box" id="content-box-2-2">
              <div class="title-date-box-3">
              ...
              <div class="content-box" id="content-box-2-3">
                <div class="title-date-box-3">
              ...
              <div class="content-box" id="content-box-2-4">
              <div class="title-date-box-3">
        ...
        <div class="search-day-conteiner">
          <div class="search-day">
            <label for="">Pesquise um mês em especifíco</label>
            <div class="search-input-conteiner">
             
              <NumberFormat id="search-input" format="##/##" allowEmptyFormatting mask="_" value={date_search} onChange={e => setDate_search(e.target.value)}/>
